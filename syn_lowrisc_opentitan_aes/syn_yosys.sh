...
for file in $LR_SYNTH_IBEX_OPENTITAN_AES/*.sv; do
  module=`basename -s .sv $file`
  echo "sv2v --define=SYNTHESIS $LR_SYNTH_IBEX_OPENTITAN_AES/*_pkg.sv $file > $LR_SYNTH_OUT_DIR/generated/${module}.v" 

  sv2v --define=SYNTHESIS $LR_SYNTH_IBEX_OPENTITAN_AES/*_pkg.sv $file > $LR_SYNTH_OUT_DIR/generated/${module}.v 
